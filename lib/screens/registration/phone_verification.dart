                          ...
                          onPressed: () async {
                            if (_formKey.currentState!.validate()) {
                              ...
                              try {
                                ...
                                // ✅ FIX: Kiểm tra user tồn tại bằng UID thay vì phoneNumber
                                ...
                                if (userDoc.exists) {
                                  ...
                                  userStorage.write('profileUrl', aUser.profileUrl);

                                  Get.offAll(() => MainScreen());
                                } else {
                                  // User chưa tồn tại → Tạo mới (KHÔNG lưu field 'uid')
